...
-- -----------------------------------------------------
-- Table `poseidondb`.`control`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `poseidondb`.`control` ;

CREATE  TABLE IF NOT EXISTS `poseidondb`.`control` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `output_id` INT(11) NULL DEFAULT NULL COMMENT 'Output_id can be NULL when a sensor_id is monitoring but does not have a connected outlet (e.g. a thermometer is connected to a wall-outlet, but the temperature sensor is still monitoring tank values)' ,
  ...
  `thresholdhigh` DECIMAL(10,2) NULL DEFAULT NULL ,
  `thresholdlow` DECIMAL(10,2) NULL DEFAULT NULL ,
  `warnhigh` DECIMAL(10,2) NULL DEFAULT NULL ,
  `warnlow` DECIMAL(10,2) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `poseidondb`.`input`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `poseidondb`.`input` ;

CREATE  TABLE IF NOT EXISTS `poseidondb`.`input` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `poseidondb`.`output`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `poseidondb`.`output` ;

CREATE  TABLE IF NOT EXISTS `poseidondb`.`output` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(250) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL ,
